...
void TestPart1() {
    ...
    const array<int, 2> a_point2d{{7, 10}}; // one parameter constructor
    Points2D<int> d{a_point2d};  // A Points2D containing (7, 10) should be created.
    cout << d;  // Should just print (7, 10).
    cout << "Enter sequence a sequence of points (integer) follow by sequence size: " << endl;
...
// a (2.1, 20.3) (11.11, 12.45) (13.1, 14.2) 
// Enter a sequence of points (double)

// b (1.1, 100) (20.1, 30.2)
void TestPart2() {
    Points2D<double> a, b;
    cout << "Enter a sequence of points (double) follow by sequence size: " << endl;
